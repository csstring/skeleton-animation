    ...
    const std::chrono::steady_clock::time_point& curTime)
{
    ...
    //3
        ...
        glm::vec3 parentDir = glm::normalize(inCharLocalPos[2] - targetPosInCharLocal);
        ...
        glm::vec3 Pos3InBone = glm::inverse(inCharTrans[2]) * glm::vec4(targetPosInCharLocal, 1);
    ...
    //2
        ...
        std::cout << glm::to_string(_groundNomal) << std::endl;
    ...
    //1
        ...
        // glm::vec3 Pos1InChar = parentDir * distance1 + Pos2InChar;
